...
public class BankingLoginTc1V5 extends BaseTest {
    ...
    public void tc002_validLoginWithOtp() {
        ...
        // Step 6: Submit
        {
            TestReporter.info("OTP submission completed [TC_002]");
    ...
    public void tc003_invalidUsername() {
        ...
        // Step 7: Leave username blank, click Login
        {
    ...
    public void tc004_invalidPassword() {
        ...
        // Step 8: Leave password blank, click Login
        {
    ...
    public void tc005_bothInvalid() {
        ...
        // Step 9: Click login without entering username or password
        {
