...
public class BankingLoginTc1V2 extends BaseTest {
    ...
    @Test(description = "TC_001: Valid banking login", priority = 1,
    ...
    public void tc001_validLogin() {
        ...
        // TC_001
        Assert.assertTrue(TestReporter.assertCondition(
                dashboardDisplayed,
    ...
    @Test(description = "TC_002: Valid banking login with OTP", priority = 2,
            groups = {"regression", "banking-login", "mfa"})
    public void tc002_validLoginWithOtp() {
        TestReporter.startTest("TC_002: Valid banking login with OTP",
    ...
    @Test(description = "TC_003: Invalid username with valid password", priority = 3,
            groups = {"regression", "banking-login", "negative"})
    public void tc003_invalidUsername() {
        TestReporter.startTest("TC_003: Invalid username",
                "Requirement: REQ-BANK-AUTH-001");
    ...
    @Test(description = "TC_004: Valid username with invalid password", priority = 4,
            groups = {"regression", "banking-login", "negative"})
    public void tc004_invalidPassword() {
        TestReporter.startTest("TC_004: Invalid password",
                "Requirement: REQ-BANK-AUTH-001");
    ...
    @Test(description = "TC_005: Invalid username and password", priority = 5,
            groups = {"regression", "banking-login", "negative"})
    public void tc005_bothInvalid() {
        TestReporter.startTest("TC_005: Both credentials invalid",
                "Requirement: REQ-BANK-AUTH-001");
        ...
        String errorText = bankingLoginPage.getErrorBannerText();
        // TC_005
        Assert.assertFalse(TestReporter.assertCondition(
                errorText.isEmpty(),
    ...
    @Test(description = "TC_006: Blank username", priority = 6,
            groups = {"regression", "banking-login", "field-validation"})
    public void tc006_emptyUsername() {
        TestReporter.startTest("TC_006: Blank username",
                "Requirement: REQ-BANK-AUTH-001");
    ...
    @Test(description = "TC_007: Blank password", priority = 7,
            groups = {"regression", "banking-login", "field-validation"})
    public void tc007_emptyPassword() {
        TestReporter.startTest("TC_007: Blank password",
                "Requirement: REQ-BANK-AUTH-001");
    ...
    @Test(description = "TC_008: Login without input", priority = 8,
            groups = {"regression", "banking-login", "field-validation"})
    public void tc008_bothFieldsEmpty() {
        TestReporter.startTest("TC_008: Login without input",
                "Requirement: REQ-BANK-AUTH-001");
    ...
    @Test(description = "TC_009: Locked account", priority = 9,
            groups = {"regression", "banking-login", "account-state"})
    public void tc009_lockedAccount() {
        TestReporter.startTest("TC_009: Locked account",
                "Requirement: REQ-BANK-AUTH-001");
    ...
    @Test(description = "TC_010: Disabled account", priority = 10,
            groups = {"regression", "banking-login", "account-state"})
    public void tc010_disabledAccount() {
        TestReporter.startTest("TC_010: Disabled account",
                "Requirement: REQ-BANK-AUTH-001");
