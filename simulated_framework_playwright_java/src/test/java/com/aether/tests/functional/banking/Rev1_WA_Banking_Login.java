        ...
        // Step 9: Enter valid username + invalid password
        {
            ...
            Assert.assertTrue(
                TestReporter.assertCondition(
                    ...
                    "FAILURE: User left login page [TC_004]"
                ),
                "User must remain on login page [TC_004]"
            );
        }
    }
        ...
        // Step 10: Enter invalid credentials
        {
            ...
            Assert.assertTrue(
                TestReporter.assertCondition(
                    ...
                    "FAILURE: User left login page [TC_005]"
                ),
                "User must remain on login page [TC_005]"
            );
        }
    }
        ...
        // Step 13: Click login without input
        {
            ...
            Assert.assertTrue(
                TestReporter.assertCondition(
                    ...
                    "FAILURE: User left login page [TC_008]"
                ),
                "User must remain on login page [TC_008]"
            );
        }
    }
}